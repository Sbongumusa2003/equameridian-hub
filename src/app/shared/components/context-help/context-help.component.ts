...
@Component({
  ...
  template: `
    <span class="context-help" (mouseenter)="open = true" (mouseleave)="open = false" (focusin)="open = true" (focusout)="open = false">
  ...
  styles: [`
    ...
    .context-help__trigger {
      width: 28px; height: 28px; min-width: 28px; min-height: 28px; border-radius: 50%;
    ...
    .context-help__trigger:hover,
    .context-help__trigger:focus-visible {
